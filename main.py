...
chrome_driver_path = "C:\\Users\\Nitish\\OneDrive\\Desktop\\chromedriver_win32.exe"
services = ChromeService(executable_path=chrome_driver_path)
driver = webdriver.Chrome(service=services)
with open("C:\\Users\\Nitish\\OneDrive\\Desktop\\Output.csv", 'w', newline='') as new_file:
...
while no_of_page < 21:
    ...
    time.sleep(10)
    product_divs = driver.find_elements(by=By.CSS_SELECTOR,
                                        value="div.sg-col-20-of-24.s-result-item.s-asin.sg-col-0-of-12.sg-col-16-of-20.sg-col.s-widget-spacing-small.sg-col-12-of-16")
    ...
    for product_div in product_divs:
        ...
        # Price
        try:
            price_a = product_div.find_elements(by=By.CSS_SELECTOR, value="a.a-section a-spacing-none aok-align-center")
            if price_a:
                price = price_a[0].find_element(by=By.CSS_SELECTOR, value="span span.a-price-whole").text
            else:
                price = ''
    ...
    with open("C:\\Users\\Nitish\\OneDrive\\Desktop\\Output.csv", 'a', newline='') as new_file:
        writer = csv.writer(new_file)
        for i in range(len(links_array)):
            datarows = [
                [links_array[i], product_names_array[i], price_array[i], rating_array[i], no_of_reviews_array[i],
                 description_array[i], asin_array[i],
